...
public class Logica {
	...
	/**
	 * Hace que el jugador produzca un disparo y lo agregue a la coleccion de
	 * entidades a agregar
	 */
	...
	/**
	 * Agrega a la Coleccion de entidades las entidades nuevas y luego limpia la
	 * cloeccion de entidades a agregar.
	 */
	...
	/**
	 * Remueve las entidades que deben ser eliminadas del juego y en caso de que sea
	 * un infectado lo remueve de la Coleccion de infectados.
	 */
	...
	/**
	 * Agrega una Entidad pasada por parametro a la coleccion de entidades a
	 * agregar.
	 */
	...
	/**
	 * Controla si se produjo una colision entre alguna de todas las entidades
	 * presentes en el juego con la Entidad pasad por parametro. Ademas llama a
	 * realizar la accion correspondiente segun la colision.
	 */
	...
	/**
	 * Agrega una entidad a ser Eliminada (porque se destruyo sliendo del
	 * mapa,colisionando o muriendose) a las entidades del juego .
	 */
	...
	/**
	 * Este metodo carga logicamente la proxima oleada correspondiente y tambien
	 * actualiza el nivel
	 */
